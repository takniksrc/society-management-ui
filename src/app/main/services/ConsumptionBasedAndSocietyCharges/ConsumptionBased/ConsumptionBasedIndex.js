...
import CBData from './ConsumptionBasedServicesBoxes';
...
function ConsumptionBasedIndex(props) {
...
export default withReducer('scrumboardApp', reducer)(withRouter(ConsumptionBasedIndex));
