...
import SCData from './SocietyChargesServicesBoxes';
...
function SocietyChargesIndex(props) {
...
export default withReducer('scrumboardApp', reducer)(withRouter(SocietyChargesIndex));
