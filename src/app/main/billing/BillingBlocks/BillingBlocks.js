...
function BillingBlocks(props) {
	...
	console.log('configSlice inside billing BillingBlocks : ', configurationsData);
	console.log('billingBlockSlice inside billing BillingBlocks : ', billingBlocksStatuses);
...
export default withReducer('scrumboardApp', reducer)(BillingBlocks);
