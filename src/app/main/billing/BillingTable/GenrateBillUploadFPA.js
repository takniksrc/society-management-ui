...
function GenrateBillUploadFPA(props) {
				...
				<div className="flex flex-grow flex-shrink-0 flex-col items-center container px-16 md:px-24">
					...
					>
						<motion.div variants={item} className="h-auto p-16" key={1}>
							<Paper
								// to={`/services/ReportsBoxesList/consumption-based-charges/${ReportsTemplates.id}/${ReportsTemplates.uri}`}
								className={clsx(
									classes.board,
...
export default withReducer('scrumboardApp', reducer)(GenrateBillUploadFPA);
