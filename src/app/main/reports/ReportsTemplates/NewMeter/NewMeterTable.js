...
import NewMeterTablePaginationActions from './NewMeterTablePaginationActions';
...
const NewMeterTable = ({ columns, data, onRowClick }) => {
	const {
		getTableProps,
		headerGroups,
		prepareRow,
	...
	return (
		<div className="flex flex-col min-h-full sm:border-1 sm:rounded-16 overflow-hidden">
			...
			<TablePagination
				...
				ActionsComponent={NewMeterTablePaginationActions}
			/>
		</div>
	);
};

NewMeterTable.propTypes = {
	columns: PropTypes.array.isRequired,
	data: PropTypes.array.isRequired,
	onRowClick: PropTypes.func
};

export default NewMeterTable;
