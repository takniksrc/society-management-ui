...
import FaultyMeterHeader from './FaultyMeterHeader';
import reducer from '../../store';
import { getMetersDetails } from '../../store/disconnectedmeterSlice';
import FaultyMeterHead from './FaultyMeterHead';
	...
	return (
		<>
			<FusePageSimple
				...
				header={<FaultyMeterHeader />}
				content={<FaultyMeterHead />}
			/>
		</>
	);
};

export default faultyMeterIndex;
