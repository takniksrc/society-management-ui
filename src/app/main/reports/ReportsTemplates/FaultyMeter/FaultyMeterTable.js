...
import FaultyMeterTablePaginationActions from './FaultyMeterTablePaginationActions';
...
const FaultyMeterTable = ({ columns, data, onRowClick }) => {
	const {
		getTableProps,
		headerGroups,
		prepareRow,
	...
	return (
		<div className="flex flex-col min-h-full sm:border-1 sm:rounded-16 overflow-hidden">
			...
			<TablePagination
				...
				ActionsComponent={FaultyMeterTablePaginationActions}
			/>
		</div>
	);
};

FaultyMeterTable.propTypes = {
	columns: PropTypes.array.isRequired,
	data: PropTypes.array.isRequired,
	onRowClick: PropTypes.func
};

export default FaultyMeterTable;
