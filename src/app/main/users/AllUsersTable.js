...
import AllUsersTablePaginationActions from './AllUsersTablePaginationActions';
...
const AllUsersTable = ({ columns, data, onRowClick }) => {
	const {
		getTableProps,
		headerGroups,
		prepareRow,
	...
	return (
		<div className="flex flex-col min-h-full sm:border-1 sm:rounded-16 overflow-hidden">
			...
			<TablePagination
				...
				ActionsComponent={AllUsersTablePaginationActions}
			/>
		</div>
	);
};
